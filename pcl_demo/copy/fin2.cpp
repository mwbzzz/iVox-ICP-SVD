...
int main(int argc, char **argv)
{
  ...
  if (pcl::io::loadPCDFile<pcl::PointXYZ>("../materials/xpd_cloud.pcd", *cloud_source) == -1)
  {
  ...
  std::cout << "RMSE of registration: " << rmse << std::endl;
  ...
  std::cout << "icp_man_kd_tree_time :" << icp_man_kd_tree_time << "s" << std::endl;
